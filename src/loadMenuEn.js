...
export function loadMenuEn(){
  ...
  /* Menu Section */
  addElement("titel","h2",[],"","Menu",[],[]);
  addElement("container","div",["d-flex","justify-content-center","flex-wrap"],"","",["id"],["the-menu"]);
  addElement("the-menu","div",["text-center","justify-content-center","align-items-center","menu-item","d-flex","flex-column"],"","",["id"],["dueruem"]); //Dürüm
  ...
  addElement("the-menu","div",["text-center","justify-content-center","align-items-center","menu-item","d-flex","flex-column"],"","",["id"],["wrap"]); //Wrap
  ...
  addElement("the-menu","div",["text-center","justify-content-center","align-items-center","menu-item","d-flex","flex-column"],"","",["id"],["kebab"]); //Kebab
  ...
  addElement("the-menu","div",["text-center","justify-content-center","align-items-center","menu-item","d-flex","flex-column"],"","",["id"],["burger"]); //Burger
